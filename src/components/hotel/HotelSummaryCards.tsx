...
export function HotelSummaryCards({
  ...
  const cards: { label: string; value: number; icon: typeof Hotel; iconBg: string; activeRing: string; filter: SummaryFilter }[] = [
    ...
    { label: t('confirmed'),         value: confirmed,   icon: CheckCircle, iconBg: 'bg-blue-100 text-blue-700',       activeRing: 'ring-blue-400',    filter: 'confirmed' },
  ...
  return (
    <div className="grid grid-cols-4 md:grid-cols-8 gap-2.5 px-4 py-3.5">
      {cards.map((card, i) => {
